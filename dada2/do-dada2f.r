...
home.dir <- ("/shared/c3/bio_db/BPA/18S/");
dir.create(paste0("/shared/c3/bio_db/BPA/18S/", plates[p,1], ".exports"));

exports <- paste0("/shared/c3/bio_db/BPA/18S/", plates[p,1], ".exports");

data.fp.gz <- paste0("/shared/c3/bio_db/BPA/18S/", plates[p,1], "/");
...
ggsave(file = paste0("/shared/c3/bio_db/BPA/18S/", plates[p,1], ".exports/", plates[p,1], ".fwd.qualplot.pdf"), fwd.plot.quals, device="pdf");

rev.plot.quals <- plotQualityProfile(fnRs[1:10]);
ggsave(file = paste0("/shared/c3/bio_db/BPA/18S/", plates[p,1], ".exports/", plates[p,1], ".rev.qualplot.pdf"), rev.plot.quals, device="pdf");
...
FWD <- "CCAGCASCYGCGGTAATTCC";  ## CHANGE ME to your forward primer sequence Archaea 16S: A2f/Arch21f Brown et al
REV <- "ACTTTCGTTCTTGATYRATGA"; ## CHANGE ME...Bacteria/Archaea 16S: 519r
...
# Flip table
write.csv(as.data.frame(seqtab.nochim), file = paste0("/shared/c3/bio_db/BPA/18S/", plates[p,1], ".exports/ASVt.",plates[p,1], ".table.csv"), col.names=NA)

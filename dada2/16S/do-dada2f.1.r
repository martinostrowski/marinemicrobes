...
setwd("/shared/c3/bio_db/BPA/16s");
...
home.dir <- ("/shared/c3/bio_db/BPA/16s/");
dir.create(paste0("/shared/c3/bio_db/BPA/16s/", plates[p,1], ".exports"));

exports <- paste0("/shared/c3/bio_db/BPA/16s/", plates[p,1], ".exports");

data.fp.gz <- paste0("/shared/c3/bio_db/BPA/16s/", plates[p,1], "/");
...
data.fp <- paste0("/shared/c3/bio_db/BPA/16s/", plates[p,1], "/"); 
...
ggsave(file = paste0("/shared/c3/bio_db/BPA/16s/", plates[p,1], ".exports/", plates[p,1], ".fwd.qualplot.pdf"), fwd.plot.quals, device="pdf");

rev.plot.quals <- plotQualityProfile(fnRs[1:10]);
ggsave(file = paste0("/shared/c3/bio_db/BPA/16s/", plates[p,1], ".exports/", plates[p,1], ".rev.qualplot.pdf"), rev.plot.quals, device="pdf");
...
FWD <- "AGAGTTTGATCMTGGCTCAG";  ## CHANGE ME to your forward primer sequence Archaea 16S: A2f/Arch21f Brown et al
...
data.fp <- paste0("/shared/c3/bio_db/BPA/16s/", plates[p,1], "/filtN");
...
data.fp <- paste0("/shared/c3/bio_db/BPA/16s/", plates[p,1], "/filtN/cutadapt");
...
out <- filterAndTrim(fnFs.cut, trimFs, fnRs.cut, trimRs, truncLen=c(260,230),
...
data.fp <- paste0("/shared/c3/bio_db/BPA/16s/", plates[p,1], "/filtN/cutadapt/trimmed");
...
ggsave(file = paste0("/shared/c3/bio_db/BPA/16s/", plates[p,1], ".exports/fwd.errors.pdf"),fwd.plot.errors, width = 10, height = 10, device="pdf");

rev.plot.errors <- plotErrors(errR, nominalQ=TRUE);
ggsave(file = paste0("/shared/c3/bio_db/BPA/16s/", plates[p,1], ".exports/rev.errors.pdf"), rev.plot.errors, width = 10, height = 10, device="pdf");
...
ggsave(file = paste0("/shared/c3/bio_db/BPA/16s/", plates[p,1], ".exports/plotLengthDist.log10.pdf"), plotLengthDist.log10, width = 10, height = 5, device="pdf");
...
# Flip table
write.csv(as.data.frame(seqtab.nochim), file = paste0("/shared/c3/bio_db/BPA/16s/", plates[p,1], ".exports/ASVt.",plates[p,1], ".table.csv"), col.names=NA)
seqtab.t <- as.data.frame(t(seqtab.nochim));
write.csv(seqtab.t, file = paste0("/shared/c3/bio_db/BPA/16s/", plates[p,1], ".exports/ASV.",plates[p,1], ".table.csv"), col.names=NA);
...
ggsave(file = paste0("/shared/c3/bio_db/BPA/16s/", plates[p,1], ".exports/track_plot.pdf"), track_plot, width = 6, height = 6, device="pdf");

plates[p,5]<-round(track_pct_avg[1,6], 2);
write_csv(plates, '/shared/c3/bio_db/BPS/16s/plates.1');
